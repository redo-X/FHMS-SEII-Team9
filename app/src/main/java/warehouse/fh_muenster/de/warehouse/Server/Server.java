...
*/
    ...
    public HashMap<Integer, Article> getPositionToCommission(int sessionId, int id) {
        ...
        try {
            SoapObject response = executeSoapAction(COMMISSION_URL, METHOD_NAME,sessionId, id);
            int resultCode = Integer.valueOf(((SoapPrimitive) response.getProperty("resultCode")).getValue().toString());
            if (resultCode == 0) {
    ...
    public void startCommission(int sessionId, int commissionId) {
        ...
        SoapObject response = null;
        try {
            response = executeSoapAction(COMMISSION_URL, METHOD_NAME,sessionId, commissionId);
        } catch (SoapFault e) {
    ...
    public void updateQuantityOnCommissionPosition(int sessionId, int commissionPositionId, int quantity) {
        ...
        SoapObject response = null;
        try {
            response = executeSoapAction(COMMISSION_URL, METHOD_NAME,sessionId, commissionPositionId, quantity);
        } catch (SoapFault e) {
    ...
    public void allocateCommission(int sessionId, int commissionId, int employeeId) {
        ...
        SoapObject response = null;
        try {
            response = executeSoapAction(COMMISSION_URL, METHOD_NAME,sessionId, commissionId, employeeId);
        } catch (SoapFault e) {
    ...
    public void commitStock(int sessionId, String artikelCode, int menge) {
        ...
        SoapObject response = null;
        try {
            response = executeSoapAction(ARTICLE_URL, METHOD_NAME,sessionId, artikelCode, menge);
        } catch (SoapFault e) {
    ...
    public HashMap<Integer, Commission> getFreeCommissions(int sessionId) {
        ...
        try {
            SoapObject response = executeSoapAction(COMMISSION_URL, METHOD_NAME, Integer.valueOf(sessionId));
            ...
            if (resultCode == 0) {
                for (int i = 1; i < response.getPropertyCount(); i++) {
                    ...
                    if (soapAccountEntry.hasProperty("commissionId") && soapAccountEntry.hasProperty("positionCount")) {
    ...
    public HashMap<Integer, Commission> getCommissions(int sessionId, Employee picker) {
        ...
        try {
            SoapObject response = executeSoapAction(COMMISSION_URL, METHOD_NAME, Integer.valueOf(sessionId), picker.getEmployeeNr());
            int resultCode = Integer.valueOf(((SoapPrimitive) response.getProperty("resultCode")).getValue().toString());
            if (resultCode == 0) {
                for (int i = 1; i < response.getPropertyCount(); i++) {
                    SoapObject soapAccountEntry = (SoapObject) response.getProperty(i);
